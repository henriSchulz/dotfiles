...
import "AirPods.js" as Model

Item {
  id: root

  // Taken from omarchy-pods (MIT, MB-JAMBON). Talks to the librepods daemon:
  // status.json is watched (no polling), librepods-ctl only runs on changes.
  ...
  readonly property string ctlPath: "librepods-ctl"
