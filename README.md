...
| `stow/claude-skills/.claude/skills/henri-ui/` | Claude-Code-Skill mit meinem verbindlichen UI-/Motion-Stil (macOS-Feeling): Motion-Tokens, Springs, Komponenten-Rezepte + fertige Dateien für QML-Plugins (`Motion.js`, `SpringValue.qml`), GTK4/libadwaita und Web (`motion.css`). Lädt automatisch bei jeder UI-Arbeit |
